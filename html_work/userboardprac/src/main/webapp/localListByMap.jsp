...
<%
	...
	// VO 대신 HashMap 타입을 사용 -> 테이블에 없는 데이터를 사용하는 경우 등
	HashMap<String, Object> map = null; // Object 타입은 어떤 데이터 값이든 저장 가능
	if (rs.next()) {
	...
	System.out.println((String) map.get("localName") + " <-- localName(map)");
	System.out.println((String) map.get("country") + " <-- localName(country)");
	System.out.println((String) map.get("worker") + " <-- localName(worker)");
