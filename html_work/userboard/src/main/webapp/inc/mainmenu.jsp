<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<div class="btn-group">
		<a href="<%=request.getContextPath()%>/home2.jsp" class="btn btn-outline-primary">홈으로</a>
		<!--
		로그인 전: 회원가입 링크	
		...
		%>	
				...
				<a href="<%=request.getContextPath()%>/local/localOne.jsp" class="btn btn-outline-primary">지역 정보</a>
