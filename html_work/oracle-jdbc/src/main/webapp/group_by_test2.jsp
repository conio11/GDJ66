...
<%
	...
	*/
	...
	while (groupByRs.next()) {
		...
		m.put("부서ID", groupByRs.getInt("부서ID"));
		m.put("직무ID", groupByRs.getString("직무ID"));
		m.put("cnt", groupByRs.getInt("cnt")); // key, value alias 통일
		list.add(m);
	}
	...
	while (groupingSetsRs.next()) {
		...
		m1.put("부서ID",	groupingSetsRs.getInt("부서ID"));
		m1.put("직무ID", groupingSetsRs.getString("직무ID"));
		m1.put("cnt", groupingSetsRs.getInt("cnt")); // key, value alias 통일
		list1.add(m1);
	}
