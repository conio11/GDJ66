 ...
 */
   ...
   // 기존 테이블에 없는 데이터를 사용하므로 HashMap<String, Object> 타입 사용 
...
<html>
	...
	<body>
		...
		<%
			// 페이징 (이전/1 ~ 10/다음)
			int pagePerPage = 10; // [이전] [다음] 탭 사이 숫자
			...
			// minPage: [이전] [다음] 탭 사이 가장 작은 수 (1, 11, 21, ,,)
			// maxPage: [이전] [다음] 탭 사이 가장 큰 수 (10, 20, 30, ,,,)
			...
			if (minPage > 1) { // minPage가 11, 21, 31, ... 인 경우
		%>		
