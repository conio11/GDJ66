...
<!DOCTYPE html>
	...
	<body>
		...
		%>
				<a href="./lastEmpListprac.jsp?currentPage=<%=currentPage - 1%>" class="btn btn-primary">이전</a>
		<%
			}
		%> 
			<%=currentPage%> 페이지
		...
		%>
				<a href="./lastEmpListprac.jsp?currentPage=<%=currentPage + 1%>" class="btn btn-primary">다음</a>
		<%
			}
		%>
		</div>
