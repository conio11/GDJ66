...
<%
	...
	System.out.println("=============modifyTeacher=============");	
%>
<!DOCTYPE html>
<html>
	<head>
	...
	<body>
		...
		<form action="<%=request.getContextPath()%>/teacher/modifyTeacherAction.jsp" method="post">
			<table class="table table-hover text-center">
				...
				<tr> 
					<th>강사 ID</th>
					<td><input type="text" name="teacherID" value="<%=teacher.getTeacherID()%>" class="form-control w-50"></td>
				</tr>
				<tr>
					<th>강사 이름</th>
					<td><input type="text" name="teacherName" value="<%=teacher.getTeacherName()%>" class="form-control w-50"></td>
				</tr>
					<tr>
					<th>강사 이력</th>
					<td><input type="text" name="teacherHistory" value="<%=teacher.getTeacherHistory()%>" class="form-control w-50"></td>
				</tr>
			</table>
			<button type="submit" class="btn btn-outline-secondary">강사 정보 수정</button>
		</form>
		</div>
	</body>
</html>